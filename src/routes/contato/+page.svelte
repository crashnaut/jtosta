			...
			<div class="p-6 pt-0">
					...
					<form class="space-y-4">
						<div>
							...
							<input
								...
								id="name"
								name="name"
								class="w-full rounded-md border p-2 bg-input"
						...
						<button
							type="submit"
							class="w-full inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"
							disabled
						>
				...
				{:else}
					...
					>
						...
						<p class="mt-4 text-sm">Por favor, utilize o WhatsApp para contato no momento.</p>
					</div>
				{/if}
			</div>
		</div>
