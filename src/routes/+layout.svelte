  ...
  <footer class="bg-muted/50 py-8">
    <div class="container mx-auto px-4 text-center text-muted-foreground">
      ...
      <div class="mb-6 flex justify-center space-x-4">
        ...
        <a 
          href="https://linktr.ee/jaquelinetosta"
          target="_blank"
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
            <path d="M7.953 15.066c-.08.163-.08.324-.08.486.08.517.528.897 1.052.89h1.294v2.5a3.06 3.06 0 0 0 2.982 3.069c.786 0 1.54-.298 2.09-.824.549-.527.868-1.228.868-1.97v-2.687h1.293c.541 0 1.004-.396 1.084-.934a1.023 1.023 0 0 0-.246-.833l-4.562-5.95a1.04 1.04 0 0 0-1.665 0l-4.562 5.95c-.081.163-.128.325-.128.487z M7.976 7.692c.08-.164.08-.328.08-.49-.08-.573-.608-.914-1.068-.89l-1.293.001v-2.5C5.7 2.015 3.55.013 1.003 0 .451.013.013.423.013.975v9.802c0 .329.134.646.366.873l4.4 5.128a1.122 1.122 0 1 0 1.695-1.466l-3.367-3.92V2.776h.574c.331 0 .63.194.763.493l3.636 4.888c.067.128.166.24.283.33z"/>
          </svg>
        </a>
      </div>
