		...
		<footer className="bg-muted/50 py-8">
			<div className="container mx-auto px-4 text-center text-muted-foreground">
				<div className="mb-4 flex justify-center space-x-6">
					...
					<Link href="/sobre" className="text-sm hover:text-primary">
						Sobre
					</Link>
					<Link href="/blog" className="text-sm hover:text-primary">
						Blog
					</Link>
					<Link href="/contato" className="text-sm hover:text-primary">
						Contato
					</Link>
				</div>
				<div className="mb-4">
				...
				<p className="text-xs">&copy; {currentYear} J. Tosta. Todos os direitos reservados.</p>
				<p className="text-xs mt-1">Desenvolvido com ❤️</p>
			</div>
		</footer>
	);
};
